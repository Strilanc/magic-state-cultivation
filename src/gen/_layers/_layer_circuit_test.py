...
def test_with_whole_measurement_layers_slid_earlier():
    ...
    """
        ...
        ).with_whole_measurement_layers_slid_earlier()
        == LayerCircuit.from_stim_circuit(
            stim.Circuit(
                """
        M 0 1 2 3
...
def test_with_whole_layers_slid_as_early_as_possible_for_merge_with_same_layer():
    ...
    """
        ...
        .with_whole_layers_slid_as_early_as_possible_for_merge_with_same_layer(
            InteractLayer
        )
        == LayerCircuit.from_stim_circuit(
            stim.Circuit(
...
def test_with_locally_merged_measure_layers():
    assert LayerCircuit.from_stim_circuit(
        stim.Circuit(
            """
                R 0 1 2
                TICK
    ...
    ).with_locally_merged_measure_layers().with_locally_optimized_layers() == LayerCircuit.from_stim_circuit(
        stim.Circuit(
            """
                R 0 1 2
                TICK
